...
.EXAMPLE
"Pester","PSDeploy","Plaster" | Install-ModuleBootstrap.ps1
Installs Pester, PSDeploy, and Plaster to your default CurrentUser modules directory.

.EXAMPLE
$ModulesToBootstrap = "Pester","PSDeploy","Plaster"
$ModulesToBootstrap | Install-ModuleBootstrap.ps1
Installs Pester, PSDeploy, and Plaster to your default CurrentUser modules directory from a variable
